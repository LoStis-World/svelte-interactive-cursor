...
| `activeDataValue`         | `{ activeDataName: string, activeDataElement: HTMLElement | null }` | `{ activeDataName: '', activeDataElement: null }`                                           | Tracks the currently active cursor data and element. |
