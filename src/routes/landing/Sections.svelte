...
<section class={['flex justify-center items-center container', sectionDefaultOptions]}>
	<h2
		data-interactive-cursor="mixblend"
		class="text-3xl text-center text-white font-extrabold lg:text-6xl leading-loose"
	>
