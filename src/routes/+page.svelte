...
<div class="grid grid-rows-[auto_1fr] p-8">
	...
	<section class="py-8">
		<h2 class="font-semibold text-2xl">
			Hover the green section to start tracking the mouse position, activate the cursor animation by hovering one of the red bordered elements!
		</h2>
	</section>


	<section id="triggersection" class="flex justify-center items-center gap-8 2xl:gap-16 p-16 border border-green-500">
		<div class="flex-1 h-96 border border-red-500 flex flex-col text-xs text-center p-8" data-interactive-cursor="image">
			<h2 class="m-auto font-semibold uppercase">Image</h2>
			<p><strong>data-interactive-cursor="image"</strong></p>
		</div>
	
		<div class="flex-1 h-96 border border-red-500 flex flex-col text-xs text-center p-8" data-interactive-cursor="video">
			<h2 class="m-auto font-semibold uppercase">Video</h2>
			<p><strong>data-interactive-cursor="video"</strong></p>
		</div>
	
		<div class="flex-1 h-96 border border-red-500 flex flex-col text-xs text-center p-8" data-interactive-cursor="link">
